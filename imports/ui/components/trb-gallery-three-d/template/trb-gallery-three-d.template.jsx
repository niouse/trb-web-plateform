...
export default function TrbGalleryThreeD_Template() {
    return (wrappedComponent) => {
        const $TrbGalleryThreeD_Template = (props) => {
            ...
            return (
                <div id="trb-gallery-three-d-container" style={styles.container}>
						...
						<div style={styles.upload}>
						  <div style={styles.legend}>Upload from file</div>
							{/*<div>
                              ...
                              <TextField type="file" id="geomInput" style={{width:"100%"}}/>
							</div>*/}
					...
					<div style={{display : "flex", flexDirection : "column", flex : 1}}>
						...
						<div key="2" id="mainView" style={{width : "100%", display : "flex", flex : 1, minHeight:"500px", backgroundColor : "white", margin:"10px"}}>
							{
								props.geometries[0] ? 
									<Gallery3dView  
