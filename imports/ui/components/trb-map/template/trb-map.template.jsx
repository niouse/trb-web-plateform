...
export default function TrbMap_Template(childs) {
        ...
        const $TrbMap_Template = (props) => {
            ...
            return (
				...
				<div style={styles.content}>
					...
					<div style={styles.mapBox}>						
						<childs.SimpleMap 	
                            ...
                            toggleMarkersOptions={()=>props.toggleStateBool('openOptions')}
                            findAndShowClient={props.findAndShowClient}
						/>
					</div>
				 ...
				 <Drawer
                  ...
                  onRequestChange={()=>props.toggleStateBool('openSearch')}
				...
				<Drawer
                    ...
                    onRequestChange={()=>props.toggleStateBool('openClientsDetails')}
				>
                  <div style={styles.closeBox} onClick={()=>props.toggleStateBool('openClientsDetails')}>
                        <div>CLOSE</div>
						<ArrowForward  style={styles.close} hoverColor="red"/>
					</div>
