...
export default function TrbMap_computeStyles(defaultStyles, stylesOptions, userStyles) {
    ...
    styles.container.height=stylesOptions.screenHeight-160
    styles.closeBox.borderBottom="1px solid "+stylesOptions.theme.colors.primary
    //console.log(stylesOptions.theme.colors.primary)
