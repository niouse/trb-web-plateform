...
import Component from "./../alarms.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Alarms_Styles_Service} from "./../services/alarms.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (alarms.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("alarms-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("alarms-" + key)
