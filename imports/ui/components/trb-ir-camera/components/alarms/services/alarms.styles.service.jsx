...
export default function Alarms_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Alarms_Styles_Service extends Component {
            constructor(props) {
                super(props)
