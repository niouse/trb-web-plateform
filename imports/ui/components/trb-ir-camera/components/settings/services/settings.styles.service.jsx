...
export default function Settings_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Settings_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $Settings_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $Settings_Styles_Service
    }
} 
