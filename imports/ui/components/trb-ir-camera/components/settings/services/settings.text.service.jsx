...
export default function Settings_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $Settings_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $Settings_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $Settings_Text_Service
    }
}
