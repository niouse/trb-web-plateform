...
import Component from "./../dashboard.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Dashboard_Styles_Service} from "./../services/dashboard.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (dashboard.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("dashboard-" + key)
