...
export default function Dashboard_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $Dashboard_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $Dashboard_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $Dashboard_Text_Service
    }
}
