...
export default function Dashboard_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Dashboard_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $Dashboard_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $Dashboard_Styles_Service
    }
} 
