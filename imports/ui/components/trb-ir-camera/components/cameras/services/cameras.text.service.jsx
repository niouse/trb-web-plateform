...
export default function Cameras_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $Cameras_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $Cameras_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $Cameras_Text_Service
    }
}
