...
export default function Cameras_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $Cameras_Styles_Service extends Component {
            constructor(props) {
                super(props)
