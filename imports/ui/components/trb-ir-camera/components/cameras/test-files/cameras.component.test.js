...
import Component from "./../cameras.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {Cameras_Styles_Service} from "./../services/cameras.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (cameras.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("cameras-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("cameras-" + key)
