...
export default function Navigation_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $Navigation_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $Navigation_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $Navigation_Text_Service
    }
}     
