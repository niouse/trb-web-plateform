...
import Component from "./../trb-ir-camera.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbIrCamera_Styles_Service} from "./../services/trb-ir-camera.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-ir-camera.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-ir-camera-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-ir-camera-" + key)
