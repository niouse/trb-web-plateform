...
export default function TrbIrCamera_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbIrCamera_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbIrCamera_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbIrCamera_Text_Service
    }
}
