...
export default function TrbIrCamera_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $TrbIrCamera_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbIrCamera_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbIrCamera_Styles_Service
    }
} 
