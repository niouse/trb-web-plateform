...
export default function  TrbIrCameraStylesOptionsService(themes){
	
	return (WrappedComponent)=>{
	
		class $TrbIrCameraStylesOptionsService extends Component {
		...
		return $TrbIrCameraStylesOptionsService
	}
}