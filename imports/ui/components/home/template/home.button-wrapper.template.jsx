...
class HomeButtonWrapper extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return  <div style={{ height : this.props.width || "90px", display:"flex", justifyContent:"center", alignItems:"center",  cursor : "pointer", padding : "15px"}} onTouchTap={this.props.onTouchTap}>
