...
export default function Home_computeStyles(defaultStyles, stylesOptions, userStyles) {
    ...
    //console.log(stylesOptions)
	styles.container.height=stylesOptions.screenHeight-180
    //console.log(styles.container.height)
    //styles.container.border="1px solid blue"
