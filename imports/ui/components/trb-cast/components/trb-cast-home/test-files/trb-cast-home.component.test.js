...
import Component from "./../trb-cast-home.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbCastHome_Styles_Service} from "./../services/trb-cast-home.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-cast-home.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-cast-home-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-cast-home-" + key)
