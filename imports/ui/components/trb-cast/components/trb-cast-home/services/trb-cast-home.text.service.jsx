...
export default function TrbCastHome_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbCastHome_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbCastHome_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbCastHome_Text_Service
    }
}
