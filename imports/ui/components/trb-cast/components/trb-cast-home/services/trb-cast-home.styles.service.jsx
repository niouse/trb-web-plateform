...
export default function TrbCastHome_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $TrbCastHome_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbCastHome_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbCastHome_Styles_Service
    }
} 
