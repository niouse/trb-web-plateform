...
export default function TrbCastConsult_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbCastConsult_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbCastConsult_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbCastConsult_Text_Service
    }
}
