...
export default function TrbCastConsult_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $TrbCastConsult_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbCastConsult_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbCastConsult_Styles_Service
    }
} 
