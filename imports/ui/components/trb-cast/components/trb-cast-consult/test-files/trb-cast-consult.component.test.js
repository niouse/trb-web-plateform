...
import Component from "./../trb-cast-consult.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbCastConsult_Styles_Service} from "./../services/trb-cast-consult.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-cast-consult.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-cast-consult-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-cast-consult-" + key)
