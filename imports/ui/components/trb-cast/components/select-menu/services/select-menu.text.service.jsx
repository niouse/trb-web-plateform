...
export default function SelectMenu_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $SelectMenu_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $SelectMenu_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $SelectMenu_Text_Service
    }
}
