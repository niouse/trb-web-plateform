...
export default function SelectMenu_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {

        class $SelectMenu_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $SelectMenu_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $SelectMenu_Styles_Service
    }
} 
