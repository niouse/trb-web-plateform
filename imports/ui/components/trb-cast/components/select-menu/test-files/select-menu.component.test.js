...
import Component from "./../select-menu.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {SelectMenu_Styles_Service} from "./../services/select-menu.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (select-menu.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("select-menu-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("select-menu-" + key)
