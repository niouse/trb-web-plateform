...
export default function TrbCastCompare_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbCastCompare_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbCastCompare_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbCastCompare_Text_Service
    }
}
