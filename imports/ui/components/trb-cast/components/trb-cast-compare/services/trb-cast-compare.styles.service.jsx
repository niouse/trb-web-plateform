...
export default function TrbCastCompare_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $TrbCastCompare_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbCastCompare_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbCastCompare_Styles_Service
    }
} 
