...
import Component from "./../trb-cast-compare.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbCastCompare_Styles_Service} from "./../services/trb-cast-compare.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-cast-compare.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-cast-compare-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-cast-compare-" + key)
