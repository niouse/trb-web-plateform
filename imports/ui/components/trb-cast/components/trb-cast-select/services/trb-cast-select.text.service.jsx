...
export default function TrbCastSelect_Text_Service(_text) {
    return (WrappedComponent) => {
        let languageSub
        class $TrbCastSelect_Text_Service extends Component {
            constructor(props) {
                super(props)
                this.state = {
                    text: _text.en
        ...
        $TrbCastSelect_Text_Service.propTypes = {
            languageObs: PropTypes.object,
            languageNext: PropTypes.func,
        };
        return $TrbCastSelect_Text_Service
    }
}
