...
export default function TrbCastSelect_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        

        class $TrbCastSelect_Styles_Service extends Component {
            constructor(props) {
                super(props)
        ...
        $TrbCastSelect_Styles_Service.propTypes = {
            stylesOptions: PropTypes.object,
            stylesOptionsObs: PropTypes.object,
        };
        return $TrbCastSelect_Styles_Service
    }
} 
