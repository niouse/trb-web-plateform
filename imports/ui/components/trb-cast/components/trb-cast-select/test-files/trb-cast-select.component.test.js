...
import Component from "./../trb-cast-select.component.jsx";
import MuiThemeProvider from 'material-ui/styles/MuiThemeProvider';

//import {TrbCastSelect_Styles_Service} from "./../services/trb-cast-select.styles.service.jsx";
...
if (Meteor.isClient) {
    ...
    describe('Component (trb-cast-select.component.jsx)', function() {
        ...
        describe('Render expected component', function() {
            it('Component contains a h1 div with expected text', function() {
                var title = document.getElementById("trb-cast-select-title")
            ...
            it('Component tag with ids are styleed correctly', function() {
                for (var key in stylesDefault) {
                    var el = document.getElementById("trb-cast-select-" + key)
